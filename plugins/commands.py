    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        for msg in msgs:
            ...
            if f_caption is None:
                f_caption = f"{title}"
            try:
                h = await message.reply_text(f"\n\nThis Movie File will be deleted in <b><u>{AUTO_DELETE} minutes</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</b>")
...
# Ask Doubt on telegram @KingVJ01
        ...
        await message.reply_text(f"\n\nThis Movie File/This Movie File will be deleted in <b><u>{AUTO_DELETE} mins</u> 🫥 <i></b>(Due to Copyright Issues)</i>.\n\n<b><i>Please forward this File/Video to your Saved Messages and Start Download there</b>")
        ...
        try:
            ...
            g = await msg.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                     [
                         InlineKeyboardButton('🖇️ ɢᴇɴᴇʀᴀᴛᴇ ᴏɴʟɪɴᴇ sᴛʀᴇᴀᴍ ʟɪɴᴋ', callback_data=f'generate_stream_link:{file_id}')
                     ]
                    ]
                )
            )
